...
딥러닝 Foundation Model을 위한 Deep Metric Learning, Contrastive Learning 그리고 LLM(+ Multi-modal, Vision) 서비스에 관심이 있습니다. 최근(2024)에는 Visual Localization 문제를 Deep Metric Learning으로 풀어내어 SCIE 급 저널에 1저자로 논문을 작성하였습니다.
